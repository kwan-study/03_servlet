...
<body>
    ...
    <form action="querystring" method="get">
        ...
        <%-- 중복 키 값이 날아간다고 생각할 수 있지만 실제로는 키값에 속한 배열로 넘어온다. --%>
        ...
        <input type="checkbox" name="hobbies" id="sleep" value="slepp"><label for="sleep">취침</label>
        <br>

        <input type="submit" value="GET 요청">
        <%-- button type="submit">GET 요청</button --%>
        <button type="button">GET 요청 fake button</button> <!-- 버튼 태그는 type을 생략하면 기본이 submit -->
    </form>

    <h4>a 태그의 href 속성에 직접 파라미터를 포함한 쿼리스트링 방식으로 작성하여 get 방식 요청하기</h4>
    <a href="querystring?name=홍길동&age=22&birthday=2003-02-01&gender=M&national=ko&hobbies=movie&hobbies=music">
...
<h4>form 태그를 이용한 post 방식 요청</h4>
    <form action="formdata" method="post">
        ...
        <button type="button">POST 요청 fake button</button> <!-- 버튼 태그는 type을 생략하면 기본이 submit -->
    </form>
