...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        /* 설명.
         *  포워딩 vs 리다이렉트
         *   - request나 response 객체를 유지하며 요청처리를 하고 싶다면 포워딩을 사용
        ...
        * */
        System.out.println("Redirect 되어 온 곳에서 request 값 확인(Attribute): "
                + req.getAttribute("test"));
        System.out.println("Redirect 되어 온 곳에서 request 값 확인(Parameter): "
